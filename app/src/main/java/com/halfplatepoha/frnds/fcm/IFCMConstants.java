...
/**
 * Created by surajkumarsau on 26/09/16.
 */
public interface IFCMConstants {
    String SONG = "SONG";
    String MESSAGE = "MESSAGE";

    String NOTIF_TYPE = "type";
    String NOTIF_FRND_ID = "friendId";
    String NOTIF_FRIEND_NAME = "friendName";
    String NOTIF_TRACK_NAME = "trackName";
